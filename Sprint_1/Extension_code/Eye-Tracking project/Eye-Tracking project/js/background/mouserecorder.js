...
{
	chrome.runtime.sendMessage({msg: 'popup::renderInfo', info: "Mouse recording paused!", type: "Alert"});
...
{
	chrome.runtime.sendMessage({msg: 'popup::renderInfo', info: "Mouse recording resumed!", type: "Alert"});
