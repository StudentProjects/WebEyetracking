...
{
    // Managing loading of test data and user info files
    public class FileLoader
    {
        ...
        /// <summary>
        /// Initializes the default location and the log test and type
        /// </summary>
        public FileLoader()
        {
            m_notificationText = "";
        ...
        /// <summary>
        /// Notifying property of a new log output message
        /// </summary>
       ...
       /// <summary>
       /// Tries to collect information about all existing test to the requested application
       /// and collect them in a string
       /// </summary>
       /// <param name="i_application">String, the application which the client wants to have information about. For example 'norran.se'</param>
       /// <returns>String, all information about the requested application. NoData if no data was found.</returns>
       ...
       /// <summary>
       /// Collects all application names existing in the main directory folder 'EyeXTestData'
       /// </summary>
       /// <returns>String, all the application names as a string. NoData if no applications existed in the main folder.</returns>
        ...
        /// <summary>
        /// Will try to collect specific test data from a certain test requested by the client based on parameters
        /// If the tests exist all the test data in the corresponding folder will be added to the datastring
        /// </summary>
        /// <param name="i_application">String, The application of the requested test</param>
        /// <param name="i_date">String, the date of the specific test</param>
        /// <param name="i_testerName">String, the name of the tester</param>
        /// <param name="i_id">Integer, the ID of the test</param>
        /// <returns>String, the datastring containing the testdata from the requested test</returns>
        ...
        /// <summary>
        /// A property which can be modified with a new value. If a new value is received this will fire an event with what this class
        /// wants to log and what type of log message it is
        /// <example>
        /// How it can look like when requesting a new log message by using this property
        /// <code>
        /// m_logType = 2;
        /// loadNotificationProperty = "File Loader: Test log message! This will be received by the server instance!";
        /// </code>
        /// </example>
        /// </summary>
